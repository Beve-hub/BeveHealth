...
const ChatField: React.FC<Props> = () => {
    ...
    const textWidth = windowWidth < 600 ?'25rem' : 'auto' ;
    const imageWidth = windowImageWidth < 600 ?'25rem' : 'auto' ;
    const imageHeight = windowImageHeight < 600 ?'20rem' : 'auto' ;
  
    
    return (
        <div style={{width: '60rem',padding:'0 2rem',background: '#F1F1F1',  borderTopRightRadius: '1rem',borderBottomRightRadius: '1rem' }}>
            <div>
            <Box style={{padding:'2rem 3rem', display:'flex', justifyContent:'space-between', }}>
               ...
               {isSmallScreen && (
                <ActionIcon color='#12121210' ><IconArrowLeft color='#121212'/></ActionIcon>
                    ...
                    <Avatar size={50}/>
                    <Text fz="20" fw="500">Dr.John</Text>
                </Group>
            ...
            <Box style={{padding:'1rem 3rem', display:'flex', justifyContent:'space-between', alignContent:'center'}}>
                ...
                <Textarea   
                 ...
                 <Group>
                    ...
                    <ActionIcon color='#12121210' ><IconMicrophone  size={24} color='#121212'/></ActionIcon>
                </Group>
                </Group>
                <Group>
